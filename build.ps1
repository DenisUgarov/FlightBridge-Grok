...
try {
 ...
 & $compiler /nologo /target:exe /out:dist\AutoMigrationTests.exe /r:System.Core.dll /r:System.Xml.Linq.dll src\Core.cs src\AutoMigration.cs src\MigrationTransaction.cs src\Migration.cs tests\AutoMigrationTests.cs
 ...
 & $compiler /nologo /target:exe /out:dist\MigrationTests.exe /r:System.Core.dll /r:System.Xml.Linq.dll src\Core.cs src\AutoMigration.cs src\MigrationTransaction.cs src\Migration.cs tests\MigrationTests.cs
