...
Копии по умолчанию сохраняются в понятную папку в Документах
(`Документы\Flight Bridge\Backups`) — **без вопроса** на главном экране.
Сменить каталог можно только через мелкую вторичную ссылку (не обязательный шаг).
